CookieControl.Dialog = function (e, o, t, i, n, s, l, a, r, d, c, y, h, C, g, p, u, b, m, B, k, f, D) {
  (that = this).name = "CybotCookiebotDialog", this.mode = o, this.template = "slidedown", this.theme = "dark", this.title = t, this.text = i, this.logo = "", this.logoAltText = "", this.acceptText = n, this.declineText = s, this.cookieIntroText = y, this.cookieIntroTypeNecessary = h, this.cookieIntroTypePreference = C, this.cookieIntroTypeStatistics = g, this.cookieIntroTypeAdvertising = p, this.cookieIntroTypeUnclassified = u, this.loiAllowAllText = "", this.loiAllowSelectionText = "", this.buttonMode = "ok", this.ooiPersonalInformation = "", this.cookieHeaderTypeNecessary = "", this.cookieHeaderTypePreference = "", this.cookieHeaderTypeStatistics = "", this.cookieHeaderTypeAdvertising = "", this.cookieHeaderTypeUnclassified = "", this.cookieTableHeaderName = "", this.cookieTableHeaderProvider = "", this.cookieTableHeaderPurpose = "", this.cookieTableHeaderType = "", this.cookieTableHeaderExpiry = "", this.showDetailsText = D, this.hideDetailsText = f, this.multiAcceptText = b, this.mandatoryText = "", this.noCookiesTypeText = "", this.aboutCookiesText = "", this.cookiesOverviewText = "", this.lastUpdatedText = "", this.lastUpdatedDate = null, this.privacyPolicyText = "", this.bulkconsentDomainsString = "", this.cookieTableNecessary = "", this.cookieTablePreference = "", this.cookieTableStatistics = "", this.cookieTableAdvertising = "", this.cookieTableUnclassified = "", this.privacyPolicies = [], this.responseMode = l, this.consentLevel = d, this.impliedConsentOnScroll = !0, this.impliedConsentOnRefresh = !1, this.userLanguage = c, this.userCountry = "", this.sliderPos = 0, this.faderPos = 100, this.detailsPos = 0, this.flashCount = 0, this.DOM = null, this.DOMid = "CybotCookiebotDialog", this.visible = !1, this.DOMoverlay = null, this.textDirection = "ltr", this.bodyOverflow = null, this.cookieconsent = e, this.cookieconsent.dialog = that, this.demomode = r, this.viewport = new CookieControl.Viewport, this.initHeight = "", this.initWidth = "", this.pageHasLoaded = !1, this.scalefactor = 1, this.isScrolling = !1, this.isInternalAlias = !1, this.showLogo = !0, this.autoHideLogoWidth = 600, this.windowInitScrolltop = 0, this.bodyPaddingTopInit = 0, this.templates = {
    top: "",
    bottom: "",
    slidedown: "",
    pushdown: "",
    ...
    popup: "",
    custom: ""
  }, this.themes = {white: "", dark: "", customcolor: ""}, this.styles = {
    top: "",
    bottom: "",
    slidedown: "",
    pushdown: "",
    ...
    statistics: !0,
    marketing: !0
  }, this.optionaloptinSettings = {displayConsentBanner: !1}, this.IABSettings = {
    purposes: [],
    specialpurposes: [],
    features: [],
    specialfeatures: [],
    ...
    vendorsCan: "",
    settings: ""
  }, null != m && (this.loiAllowAllText = m), null != B && (this.loiAllowSelectionText = B), null != k && (this.buttonMode = k)
}, CookieControl.Dialog.prototype.getCookieTableHTML = function (e, o, t, i) {
  var n = document.createElement("span");
  n.innerHTML = t, cookieTable = n.firstChild;
  for (var s = 0; s < o.length; s++) {
    var l = cookieTable.tBodies[0].insertRow(-1);
    for (j = 0; j <= 4; j++) {
      var a = l.insertCell(j);
      if (a.innerHTML = o[s][j], 0 == j) {
        var r = o[s][1].split("<br/>").length;
        1 < r && (a.innerHTML += "&nbsp;[x" + r + "]")
      } else if (1 == j) {
        var d = o[s][j].split("<br/>");
        if (7 < o[s].length && (d = o[s][7].split("<br/>")), 1 < d.length) {
          for (var c = "", y = [], h = 0; h < d.length; h++) {
            var C = this.getDomainLabel(d[h]);
            -1 == y.indexOf(C) && (y.push(C), c += C, h < d.length - 1 && (c += "<br/>"))
          }
          a.innerHTML = c
        } else 7 < o[s].length ? a.innerHTML = this.getDomainLabel(o[s][7]) : a.innerHTML = this.getDomainLabel(o[s][j])
      }
  ...
  if (0 == o.length) {
    ...
    var g = cookieTable.insertRow(0).insertCell(0);
    g.style.textAlignment = i, g.innerHTML = this.noCookiesTypeText, g.className = "CybotCookiebotDialogDetailBodyContentCookieTypeTableEmpty"
  }
  ...
  var o = e;
  if (0 < this.privacyPolicies.length) for (i = 0; i < this.privacyPolicies.length; i++) if (this.privacyPolicies[i][0] == e) {
  ...
  var e, o = document.createEvent("Event");
  o.initEvent("CookiebotOnDialogInit", !0, !0), window.dispatchEvent(o), (o = document.createEvent("Event")).initEvent("CookieConsentOnDialogInit", !0, !0), window.dispatchEvent(o), !this.mode in this.modes && (this.mode = "slidedown_dark", this.theme = "dark", this.template = "slidedown"), 0 < this.mode.indexOf("_") && (this.template = this.mode.split("_")[0], this.theme = this.mode.split("_")[1]), this.clearDOM(), this.demomode ? this.loadDemoTemplates() : this.loadTemplates(), e = "custom" == this.template ? this.customTemplateDef.HTML : this.templates[this.template];
  var t = document.createElement("div");
  t.innerHTML = e.replace(/\[#TITLE#]/g, this.title).replace(/\[#TEXT#]/g, this.text.replace(/\n/g, "")).replace(/\[#ACCEPT#]/g, this.acceptText).replace(/\[#DECLINE#]/g, this.declineText).replace(/\[#DETAILS#\]/g, this.showDetailsText).replace(/\[#LOGO#]/g, this.logo).replace(/\[#LOGOALT#]/g, this.logoAltText), "" != this.bulkconsentDomainsString ? t.innerHTML = t.innerHTML.replace(/\[#COOKIESGENERALINTRO#]/g, this.cookieIntroText.replace(/\n/g, "") + "<br><br>" + this.bulkconsentDomainsString + "<br><br>").replace(/\[#COOKIETYPEINTRO_NECESSARY#]/g, this.cookieIntroTypeNecessary.replace(/\n/g, "")).replace(/\[#COOKIETYPEINTRO_PREFERENCE#]/g, this.cookieIntroTypePreference.replace(/\n/g, "")).replace(/\[#COOKIETYPEINTRO_STATISTICS#]/g, this.cookieIntroTypeStatistics.replace(/\n/g, "")).replace(/\[#COOKIETYPEINTRO_ADVERTISING#]/g, this.cookieIntroTypeAdvertising.replace(/\n/g, "")).replace(/\[#COOKIETYPEINTRO_UNCLASSIFIED#]/g, this.cookieIntroTypeUnclassified.replace(/\n/g, "")) : t.innerHTML = t.innerHTML.replace(/\[#COOKIESGENERALINTRO#]/g, this.cookieIntroText.replace(/\n/g, "")).replace(/\[#COOKIETYPEINTRO_NECESSARY#]/g, this.cookieIntroTypeNecessary.replace(/\n/g, "")).replace(/\[#COOKIETYPEINTRO_PREFERENCE#]/g, this.cookieIntroTypePreference.replace(/\n/g, "")).replace(/\[#COOKIETYPEINTRO_STATISTICS#]/g, this.cookieIntroTypeStatistics.replace(/\n/g, "")).replace(/\[#COOKIETYPEINTRO_ADVERTISING#]/g, this.cookieIntroTypeAdvertising.replace(/\n/g, "")).replace(/\[#COOKIETYPEINTRO_UNCLASSIFIED#]/g, this.cookieIntroTypeUnclassified.replace(/\n/g, ""));
  var i = this.lastUpdatedText;
  if (void 0 !== this.userCulture && null != this.userCulture && void 0 !== this.lastUpdatedDate && null != this.lastUpdatedDate) {
    var n = {timeZone: "UTC", dateStyle: "short"}, s = "", l = new Date(this.lastUpdatedDate);
    try {
      s = l.toLocaleDateString(this.userCulture, n)
    } catch (e) {
      s = l.toLocaleDateString("en-GB", n)
    }
    i = i.replace(/\{0\}/g, s)
  }
  if (t.innerHTML = t.innerHTML.replace(/\[#ABOUTCOOKIES#\]/g, this.aboutCookiesText).replace(/\[#COOKIESOVERVIEW#\]/g, this.cookiesOverviewText).replace(/\[#LASTUPDATED#\]/g, i).replace(/\[#COOKIETYPE_NECESSARY#\]/g, this.cookieHeaderTypeNecessary.replace("{0}", this.cookieTableNecessaryCount)).replace(/\[#COOKIETYPE_PREFERENCE#\]/g, this.cookieHeaderTypePreference.replace("{0}", this.cookieTablePreferenceCount)).replace(/\[#COOKIETYPE_STATISTICS#\]/g, this.cookieHeaderTypeStatistics.replace("{0}", this.cookieTableStatisticsCount)).replace(/\[#COOKIETYPE_ADVERTISING#\]/g, this.cookieHeaderTypeAdvertising.replace("{0}", this.cookieTableAdvertisingCount)).replace(/\[#COOKIETYPE_UNCLASSIFIED#\]/g, this.cookieHeaderTypeUnclassified.replace("{0}", this.cookieTableUnclassifiedCount)), t.innerHTML = t.innerHTML.replace(/\[#COOKIETYPE_NECESSARY_RAW#\]/g, this.cookieHeaderTypeNecessary.replace(" ({0})", "")).replace(/\[#COOKIETYPE_PREFERENCE_RAW#\]/g, this.cookieHeaderTypePreference.replace(" ({0})", "")).replace(/\[#COOKIETYPE_STATISTICS_RAW#\]/g, this.cookieHeaderTypeStatistics.replace(" ({0})", "")).replace(/\[#COOKIETYPE_ADVERTISING_RAW#\]/g, this.cookieHeaderTypeAdvertising.replace(" ({0})", "")).replace(/\[#COOKIETYPE_UNCLASSIFIED_RAW#\]/g, this.cookieHeaderTypeUnclassified.replace(" ({0})", "")), t.innerHTML = t.innerHTML.replace(/\[#ACCEPTOK#\]/g, this.multiAcceptText), t.innerHTML = t.innerHTML.replace(/\[#MULTIACCEPT#\]/g, this.multiAcceptText), t.innerHTML = t.innerHTML.replace(/\[#LANGUAGE#\]/g, this.userLanguage), "" != this.ooiPersonalInformation && (t.innerHTML = t.innerHTML.replace(/\[#OOI_PERSONAL_INFORMATION#\]/g, this.ooiPersonalInformation)), t.innerHTML = t.innerHTML.replace(/\[#LEVELOPTIN_ALLOWALL#\]/g, this.loiAllowAllText), t.innerHTML = t.innerHTML.replace(/\[#LEVELOPTIN_ALLOW_SELECTION#\]/g, this.loiAllowSelectionText), this.cookieconsent.hasFramework && "iab" == this.cookieconsent.framework.toLowerCase()) {
    t.innerHTML = t.innerHTML.replace(/\[#IABSETTINGS#\]/g, this.IABResourceStrings.tabHeader);
    var a = "";
    a += "<div class='CybotCookiebotDialogBodyIABIntroContainer'>" + this.IABResourceStrings.generalIntro + "</div>", a += "<div class='CybotCookiebotDialogBodyLevelButtonIABHeader'>" + this.IABResourceStrings.purpose + "<span class='CybotCookiebotDialogBodyLevelButtonIABHeaderToggle'><a href='javascript: CookieConsentDialog.IABSelectPurposes()'>" + this.IABResourceStrings.selectAll + "</a> | <a href='javascript: CookieConsentDialog.IABDeselectPurposes()'>" + this.IABResourceStrings.deselectAll + "</a></span></div>", a += "<div class='CybotCookiebotDialogBodyIABIntroContainer'>" + this.IABResourceStrings.purposeIntro + "</div>";
    for (var r = 0; r < this.IABSettings.purposes.length; r++) a += "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABPurpose" + this.IABSettings.purposes[r].id + "' data-iabpurposeid='" + this.IABSettings.purposes[r].id + "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonPurposes' checked='checked' tabindex='0'><label for='CybotCookiebotDialogBodyLevelButtonIABPurpose" + this.IABSettings.purposes[r].id + "'>" + this.IABSettings.purposes[r].name + "</label></div>", a += "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" + this.IABSettings.purposes[r].description + "</div>";
    a += "<div class='CybotCookiebotDialogBodyLevelButtonIABHeader'>" + this.IABResourceStrings.feature + "</div>";
    for (r = 0; r < this.IABSettings.features.length; r++) a += "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><label style='font-weight:bold'>" + this.IABSettings.features[r].name + "</label></div>", a += "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" + this.IABSettings.features[r].description + "</div>";
    a += "<br><div class='CybotCookiebotDialogBodyLevelButtonIABHeader'>" + this.IABResourceStrings.thirdPartyVendors + "<span class='CybotCookiebotDialogBodyLevelButtonIABHeaderToggle'><a href='javascript: CookieConsentDialog.IABSelectVendors()'>" + this.IABResourceStrings.selectAll + "</a> | <a href='javascript: CookieConsentDialog.IABDeselectVendors()'>" + this.IABResourceStrings.deselectAll + "</a></span></div>", a += "<div class='CybotCookiebotDialogBodyIABIntroContainer'>" + this.IABResourceStrings.vendorIntro + "</div>";
    for (r = 0; r < this.IABSettings.vendors.length; r++) {
      if (a += "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABVendor" + this.IABSettings.vendors[r].id + "' data-iabvendorid='" + this.IABSettings.vendors[r].id + "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonVendors' checked='checked' tabindex='0'><label for='CybotCookiebotDialogBodyLevelButtonIABVendor" + this.IABSettings.vendors[r].id + "'>" + this.IABSettings.vendors[r].name + "</label></div>", a += "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" + this.IABResourceStrings.policyURL + ": <a href='" + this.IABSettings.vendors[r].policyUrl + "' target='_blank' rel='noopener noreferrer nofollow'>" + this.IABSettings.vendors[r].policyUrl + "</a>", 0 < this.IABSettings.vendors[r].purposeIds.length) {
        a += "<br>" + this.IABResourceStrings.purpose + ": ";
        for (var d = 0; d < this.IABSettings.vendors[r].purposeIds.length; d++) a += '"' + this.getIABPurposeById(this.IABSettings.vendors[r].purposeIds[d]) + '"', d < this.IABSettings.vendors[r].purposeIds.length - 1 ? a += ", " : a += "."
      }
      if (0 < this.IABSettings.vendors[r].legIntPurposeIds.length) {
        a += "<br>" + this.IABResourceStrings.purposeLegitimateInterest + ": ";
        for (d = 0; d < this.IABSettings.vendors[r].legIntPurposeIds.length; d++) a += '"' + this.getIABPurposeById(this.IABSettings.vendors[r].legIntPurposeIds[d]) + '"', d < this.IABSettings.vendors[r].legIntPurposeIds.length - 1 ? a += ", " : a += "."
      }
      if (0 < this.IABSettings.vendors[r].featureIds.length) {
        a += "<br>" + this.IABResourceStrings.feature + ": ";
        for (d = 0; d < this.IABSettings.vendors[r].featureIds.length; d++) a += '"' + this.getIABFeatureById(this.IABSettings.vendors[r].featureIds[d]) + '"', d < this.IABSettings.vendors[r].featureIds.length - 1 ? a += ", " : a += "."
      }
      a += "</div>"
    }
    t.innerHTML = t.innerHTML.replace(/\[#COOKIESIABCONTENT#\]/g, a)
  } else if (this.cookieconsent.hasFramework && "iabv2" == this.cookieconsent.framework.toLowerCase()) {
    var c = t.innerHTML;
    c = (c = c.replace(/\[#IABV2SETTINGS#\]/g, this.IABResourceStrings.tabHeader)).replace(/\[#IABV2_LABEL_SETTINGS#\]/g, this.IABResourceStrings.settings).replace(/\[#IABV2_LABEL_PURPOSES#\]/g, this.IABResourceStrings.purpose).replace(/\[#IABV2_LABEL_FEATURES#\]/g, this.IABResourceStrings.feature).replace(/\[#IABV2_LABEL_PARTNERS#\]/g, this.IABResourceStrings.partners);
    var y = "<div>" + this.IABResourceStrings.generalIntro + "<br/><br/>" + this.IABResourceStrings.legitimateInterestIntro.replace("<a>", "<a href=\"javascript: CookieConsent.dialog.showCookieContainerIABv2DetailPane('partners');\">");
    y += "<br/><br/>" + this.IABResourceStrings.preferencesIntro + "</br></br></div>", y += "<div class='CybotCookiebotDialogBodyLevelButtonIABHeader'>" + this.IABResourceStrings.purpose + "<span class='CybotCookiebotDialogBodyLevelButtonIABHeaderToggle'><a href='javascript: CookieConsentDialog.IABSelectPurposes()'>" + this.IABResourceStrings.selectAll + "</a> | <a href='javascript: CookieConsentDialog.IABDeselectPurposes()'>" + this.IABResourceStrings.deselectAll + "</a></span></div>", y += "<div class='CybotCookiebotDialogBodyIABIntroContainer'>" + this.IABResourceStrings.purposeIntro + "</div>";
    var h = [];
    for (r in this.IABGVL.purposes) h.push(this.IABGVL.purposes[r].id);
    var C = [];
    for (r in this.IABGVL.specialPurposes) C.push(this.IABGVL.specialPurposes[r].id);
    var g = [];
    for (r in this.IABGVL.features) g.push(this.IABGVL.features[r].id);
    var p = [];
    for (r in this.IABGVL.specialFeatures) p.push(this.IABGVL.specialFeatures[r].id);
    var u = this.IABSortedVendorList;
    if (CookieConsent.inlineConfiguration && null != CookieConsent.inlineConfiguration && CookieConsent.inlineConfiguration.Frameworks && CookieConsent.inlineConfiguration.Frameworks.IABTCF2) {
      if (CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedPurposes && (h = CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedPurposes), CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedSpecialPurposes && (C = CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedSpecialPurposes), CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedFeatures && (g = CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedFeatures), CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedSpecialFeatures && (p = CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedSpecialFeatures), CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedVendors && 0 < CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedVendors.length) {
        u = [];
        for (r = 0; r < this.IABSortedVendorList.length; r++) if (0 <= CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedVendors.indexOf(this.IABSortedVendorList[r])) {
          var b = this.IABGVL.vendors[this.IABSortedVendorList[r]];
          u.push(b.id)
        }
      }
      for (r = 0; r < u.length; r++) {
        if ((b = u[r]).specialPurposes && 0 < b.specialPurposes.length) for (var m = 0; m < b.specialPurposes.length; m++) C.indexOf(b.specialPurposes[m]) < 0 && C.push(b.specialPurposes[m]);
        if (b.features && 0 < b.features.length) for (m = 0; m < b.features.length; m++) g.indexOf(b.features[m]) < 0 && g.push(b.features[m])
      }
    }
    for (r = 0; r < h.length; r++) {
      var B = this.IABGVL.purposes[h[r]];
      y += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainer'>", y += "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABPurpose" + B.id + "' data-iabpurposeid='" + B.id + "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonPurposes' checked='checked' tabindex='0'><label class='CybotCookiebotDialogBodyLevelButtonIABLabel' for='CybotCookiebotDialogBodyLevelButtonIABPurpose" + B.id + "'>" + B.name + "</label></div>", 1 != B.id && (y += "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABPurposeLegitimateInterest" + B.id + "' data-iabpurposeid='" + B.id + "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonPurposesLegitimateInterestSelection' checked='checked' tabindex='0'><label for='CybotCookiebotDialogBodyLevelButtonIABPurposeLegitimateInterest" + B.id + "'>" + this.IABResourceStrings.legitimateInterestHeader + "</label></div>"), y += "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" + B.descriptionLegal.replace("* ", '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet"><li>').replace(/\* /g, "</li><li>") + "</li></ul></div>", y += "</div>"
    }
    if (0 < C.length) {
      y += "<div class='CybotCookiebotDialogBodyLevelButtonIABHeader' style='margin-top:12px;border-top:none'>" + this.IABResourceStrings.specialPurpose + "</div>";
      for (r = 0; r < C.length; r++) {
        var k = this.IABGVL.specialPurposes[C[r]];
        y += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainer'>", y += "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><label class='CybotCookiebotDialogBodyLevelButtonIABLabel'>" + k.name + "</label></div>", y += "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" + k.descriptionLegal.replace("* ", '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet"><li>').replace(/\* /g, "</li><li>") + "</li></ul></div>", y += "</div>"
      }
    }
    if (c = c.replace(/\[#IABV2_BODY_PURPOSES#\]/g, y), 0 < g.length) {
      var f = "<div class='CybotCookiebotDialogBodyLevelButtonIABHeader' style='margin-top:0;border-top:none;padding-top:0;'>" + this.IABResourceStrings.feature + "</div>";
      for (r = 0; r < g.length; r++) {
        var D = this.IABGVL.features[g[r]];
        f += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainer'>", f += "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><label class='CybotCookiebotDialogBodyLevelButtonIABLabel'>" + D.name + "</label></div>", f += "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" + D.descriptionLegal.replace("* ", '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet"><li>').replace(/\* /g, "</li><li>") + "</li></ul></div>", f += "</div>"
      }
    }
    if (0 < p.length) {
      f += "<div class='CybotCookiebotDialogBodyLevelButtonIABHeader' style='margin-top:12px;border-top:none'>" + this.IABResourceStrings.specialFeature + "<span class='CybotCookiebotDialogBodyLevelButtonIABHeaderToggle'><a href='javascript: CookieConsentDialog.IABSelectFeatures()'>" + this.IABResourceStrings.selectAll + "</a> | <a href='javascript: CookieConsentDialog.IABDeselectFeatures()'>" + this.IABResourceStrings.deselectAll + "</a></span></div>";
      for (r = 0; r < p.length; r++) {
        var I = this.IABGVL.specialFeatures[p[r]];
        f += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainer'>", f += "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABFeature" + I.id + "' data-iabspecialfeatureid='" + I.id + "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonFeatures' checked='checked' tabindex='0'><label class='CybotCookiebotDialogBodyLevelButtonIABLabel' for='CybotCookiebotDialogBodyLevelButtonIABFeature" + I.id + "'>" + I.name + "</label></div>", f += "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" + I.descriptionLegal.replace("* ", '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet"><li>').replace(/\* /g, "</li><li>") + "</li></ul></div>", f += "</div>"
      }
    }
    ...
    c = c.replace(/\[#IABV2_BODY_FEATURES#\]/g, f);
    var A = this.IABResourceStrings.partnersIntro + " " + this.IABResourceStrings.legitimateInterestVendorObjection;
    ...
    for (r = 0; r < u.length; r++) {
      var T = v((b = this.IABGVL.vendors[u[r]]).purposes, h), L = v(b.legIntPurposes, h), E = v(b.specialPurposes, C),
        w = v(b.features, g), S = v(b.features, p);
      if (A += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainerCollapsed' id='CybotCookiebotDialogBodyLevelButtonIABVendorContainer" + b.id + "'>", A += "<a title='" + this.IABResourceStrings.expand + "' class='CybotCookiebotDialogBodyLevelButtonIABContainerToggleShow' href='javascript: CookieConsentDialog.IABToggleContainer(\"CybotCookiebotDialogBodyLevelButtonIABVendorContainer" + b.id + "\")'></a>", A += "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABVendor" + b.id + "' data-iabvendorid='" + b.id + "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonVendors' checked='checked' tabindex='0'><label class='CybotCookiebotDialogBodyLevelButtonIABLabel' for='CybotCookiebotDialogBodyLevelButtonIABVendor" + b.id + "'>" + b.name + "</label></div>", 0 < b.legIntPurposes.length) {
        var O = !1;
        for (d = 0; d < b.legIntPurposes.length; d++) if (0 <= L.indexOf(b.legIntPurposes[d])) {
          O = !0;
          break
        }
        O && (A += "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABVendorLegitimateInterest" + b.id + "' data-iabvendorid='" + b.id + "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonVendorsLegitimateInterestSelection' checked='checked' tabindex='0'><label for='CybotCookiebotDialogBodyLevelButtonIABVendorLegitimateInterest" + b.id + "'>" + this.IABResourceStrings.legitimateInterestHeader + "</label></div>")
      }
      if (A += "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" + this.IABResourceStrings.policyURL + ": <a href='" + b.policyUrl + "' target='_blank' rel='noopener noreferrer nofollow'>" + b.policyUrl + "</a><br/>", 0 < T.length) {
        A += "<br>" + this.IABResourceStrings.purpose + " (" + this.IABResourceStrings.consent + "): ", A += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">';
        for (d = 0; d < T.length; d++) A += "<li>" + this.getIAB2PurposeById(T[d]) + "</li>";
        A += "</ul>"
      }
      if (0 < L.length) {
        A += "<br>" + this.IABResourceStrings.purpose + " (" + this.IABResourceStrings.legitimateInterestHeader + "): ", A += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">';
        for (d = 0; d < L.length; d++) A += "<li>" + this.getIAB2PurposeById(L[d]) + "</li>";
        A += "</ul>"
      }
      if (0 < E.length) {
        A += "<br>" + this.IABResourceStrings.specialPurpose + ": ", A += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">';
        for (d = 0; d < E.length; d++) A += "<li>" + this.getIAB2PurposeById(E[d]) + "</li>";
        A += "</ul>"
      }
      if (0 < w.length) {
        A += "<br>" + this.IABResourceStrings.feature + ": ", A += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">';
        for (d = 0; d < w.length; d++) A += "<li>" + this.getIAB2FeatureById(w[d]) + "</li>";
        A += "</ul>"
      }
      if (0 < S.length) {
        A += "<br>" + this.IABResourceStrings.specialFeature + ": ", A += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">';
        for (d = 0; d < S.length; d++) A += "<li>" + this.getIAB2FeatureById(S[d]) + "</li>";
        A += "</ul>"
      }
      A += "</div></div>"
    }
    c = c.replace(/\[#IABV2_BODY_PARTNERS#\]/g, A), t.innerHTML = c
  }
  var M = ["ar", "he", "fa", "az", "ur", "pa", "ps", "ug", "yi"], x = "left";
  this.textDirection = "ltr";
  for (m = 0; m < M.length; m++) if (M[m] === this.userLanguage.toLowerCase()) {
    this.textDirection = "rtl", x = "right";
    break
  }
  t.innerHTML = t.innerHTML.replace(/\[#TEXTDIRECTION#\]/g, this.textDirection);
  var P = '<table><thead><tr><th scope="col">' + this.cookieTableHeaderName + '</th><th scope="col">' + this.cookieTableHeaderProvider + '</th><th scope="col">' + this.cookieTableHeaderPurpose + '</th><th scope="col">' + this.cookieTableHeaderExpiry + '</th><th scope="col">' + this.cookieTableHeaderType + "</th></tr></thead><tbody></tbody></table>";
  if (t.innerHTML = t.innerHTML.replace(/\[#COOKIETABLE_NECESSARY#]/g, this.getCookieTableHTML("Necessary", this.cookieTableNecessary, P, x)), t.innerHTML = t.innerHTML.replace(/\[#COOKIETABLE_PREFERENCE#]/g, this.getCookieTableHTML("Preference", this.cookieTablePreference, P, x)), t.innerHTML = t.innerHTML.replace(/\[#COOKIETABLE_STATISTICS#]/g, this.getCookieTableHTML("Statistics", this.cookieTableStatistics, P, x)), t.innerHTML = t.innerHTML.replace(/\[#COOKIETABLE_ADVERTISING#]/g, this.getCookieTableHTML("Advertising", this.cookieTableAdvertising, P, x)), t.innerHTML = t.innerHTML.replace(/\[#COOKIETABLE_UNCLASSIFIED#]/g, this.getCookieTableHTML("Unclassified", this.cookieTableUnclassified, P, x)), this.DOM = t.firstChild, !this.demomode && !this.cookieconsent.hasResponse) if ("implied" == this.consentLevel && "undefined" == typeof CookieDeclaration) if ("-2" == this.cookieconsent.consentID) {
    var H = window.location.href;
    document.referrer && 0 === document.referrer.indexOf(location.protocol + "//" + location.host) && (H = document.referrer), this.submitConsent(!0, H)
  } else {
    if (void 0 === this.cookieconsent.getCookie(this.cookieconsent.name) && this.impliedConsentOnRefresh) if (0 < this.cookieconsent.pathlist.length) for (var R = 0; R < this.cookieconsent.pathlist.length; R++) this.cookieconsent.setCookie("-2", null, this.cookieconsent.pathlist[R]); else this.cookieconsent.setCookie("-2", null, "/");
  ...
  var e = document.getElementsByTagName("body")[0], o = this;
  ...
  if (this.DOM.style.display = "none", "undefined" != this.DOM.id && "" != this.DOM.id && null != this.DOM.id ? this.DOMid = this.DOM.id : this.DOM.id = this.DOMid, this.DOM.setAttribute("name", this.DOMid), this.name = this.DOMid, this.clearDOM(), e.firstChild ? this.DOM = e.insertBefore(this.DOM, e.firstChild) : this.DOM = e.appendChild(this.DOM), this.appendStyle(this.template), this.isInternalAlias) {
    var o = document.createElement("div");
    o.innerHTML = "TEST", o.style.position = "absolute", o.style.fontSize = "100px", o.style.opacity = "0.25", o.style.fontWeight = "bold", o.style.overflow = "visible", o.style.pointerEvents = "none", o.style.height = "0", o.style.width = "0", o.style.wordWrap = "normal", this.DOM.insertBefore(o, this.DOM.firstChild)
  }
  ...
  if (this.DOM.addEventListener ? (this.DOM.addEventListener("mousewheel", t, !1), this.DOM.addEventListener("wheel", t, !1), this.DOM.addEventListener("DOMMouseScroll", t, !1), this.DOM.addEventListener("scroll", t, !1)) : this.DOM.attachEvent && (this.DOM.attachEvent("onmousewheel", t, !1), this.DOM.attachEvent("wheel", t, !1), this.DOM.attachEvent("onscroll", t, !1)), "custom" != this.template) {
    if ("" == this.title && (document.getElementById("CybotCookiebotDialogBodyContentTitle").style.display = "none"), "" == this.text && (document.getElementById("CybotCookiebotDialogBodyContentText").style.display = "none"), !this.showLogo || this.viewport.winWidth() <= this.autoHideLogoWidth) if (document.getElementById("CybotCookiebotDialogPoweredbyLink").style.display = "none", "rtl" == this.textDirection) switch ("overlay" == this.template || "popup" == this.template ? (document.getElementById("CybotCookiebotDialogBodyContent").style.paddingRight = "16px", "leveloptin" == this.responseMode ? document.getElementById("CybotCookiebotDialogBodyLevelButtons").style.marginRight = "8px" : document.getElementById("CybotCookiebotDialogBodyButtons").style.paddingRight = "8px") : (document.getElementById("CybotCookiebotDialogBodyContent").style.paddingRight = "8px", "leveloptin" == this.responseMode ? document.getElementById("CybotCookiebotDialogBodyLevelButtons").style.marginRight = "8px" : document.getElementById("CybotCookiebotDialogBodyButtons").style.paddingRight = "0px"), "leveloptin" != this.responseMode && (document.getElementById("CybotCookiebotDialogBodyButtons").firstChild.style.marginRight = "2px"), this.responseMode) {
      case"leveloptin":
    ...
    if (this.cookieconsent.hasFramework && "iab" == this.cookieconsent.framework.toLowerCase()) (i = document.getElementById("CybotCookiebotDialogDetailBodyContentTabsIAB")) && (i.style.display = "inline-block"); else if (this.cookieconsent.hasFramework && "iabv2" == this.cookieconsent.framework.toLowerCase()) {
      var i;
      (i = document.getElementById("CybotCookiebotDialogDetailBodyContentTabsIABv2")) && (i.style.display = "inline-block")
    }
    this.viewport.addResizeEvent(function () {
      y.resize()
    });
    var n = document.getElementById("CybotCookiebotDialogBodyContentControls");
    if (null != n && (n.style.display = "none"), "optin" == this.responseMode) (d = document.getElementById("CybotCookiebotDialogBodyButtonDecline")).style.display = "none"; else if ("optionaloptin" == this.responseMode) {
      document.getElementById("CybotCookiebotDialogBodyButtonDecline").style.display = "none";
      var s = document.getElementById("CybotCookiebotDialogBodyButtonAccept"),
        l = document.getElementById("CybotCookiebotDialogBodyLevelButtonAccept");
      s.innerHTML = l.innerHTML, n.style.display = "inline"
    } else if ("optout" == this.responseMode) {
      (C = document.getElementById("CybotCookiebotDialogBodyButtonAccept")).style.display = "none"
    } else if ("leveloptin" == this.responseMode) {
      document.getElementById("CybotCookiebotDialogBodyButtons").style.display = "none", (h = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerNecessary")).style.borderTop = "0", document.getElementById("CybotCookiebotDialogBodyLevelWrapper").style.display = "block";
      var a = document.getElementById("CybotCookiebotDialogBodyLevelButtonLevelOptinAllowallSelectionWrapper"),
        r = document.getElementById("CybotCookiebotDialogBodyLevelButtonAcceptWrapper");
      if ("allowselectdecline" == this.buttonMode || "allowallorselection" == this.buttonMode) null != a && (a.style.display = "block"), null != r && (r.style.display = "none"), null !== (d = document.getElementById("CybotCookiebotDialogBodyLevelButtonLevelOptinDeclineAll")) && (d.style.display = "allowselectdecline" == this.buttonMode ? "" : "none"); else null != a && (a.style.display = "none"), null != r && (r.style.display = "block");
      if (!function () {
        var e = document.getElementById("CybotCookiebotDialogBodyLevelButtonNecessary");
        e && (e.parentNode.title = y.htmlDecode(y.mandatoryText) + " " + y.htmlDecode(y.cookieIntroTypeNecessary.replace(/<[^>]*>?/gm, "")));
        var o = document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences");
        o && (o.parentNode.title = y.htmlDecode(y.cookieIntroTypePreference.replace(/<[^>]*>?/gm, "")));
        var t = document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics");
        t && (t.parentNode.title = y.htmlDecode(y.cookieIntroTypeStatistics.replace(/<[^>]*>?/gm, "")));
        var i = document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing");
        i && (i.parentNode.title = y.htmlDecode(y.cookieIntroTypeAdvertising.replace(/<[^>]*>?/gm, "")))
      }(), this.cookieconsent.hasFramework && ("iab" == this.cookieconsent.framework.toLowerCase() || "iabv2" == this.cookieconsent.framework.toLowerCase())) (c = document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing")).onclick = function () {
      ...
      var d;
      (d = document.getElementById("CybotCookiebotDialogBodyButtonDecline")).style.display = "none";
      var c, h, C = document.getElementById("CybotCookiebotDialogBodyButtonAccept"),
        g = document.getElementById("CybotCookiebotDialogBodyLevelButtonAccept");
      C.innerHTML = g.innerHTML, (c = document.getElementById("CybotCookiebotDialogBodyLevelButtonNecessary")).style.zIndex = 1e4, c.style.position = "absolute", (h = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerNecessary")).title = this.htmlDecode(this.mandatoryText), h.style.paddingTop = "7px", h.style.paddingBottom = "5px", h.style.position = "relative", h.style.zIndex = 1, h.removeAttribute("href"), h.onclick = function (e) {
        "A" == e.target.tagName && CookieConsent.dialog.showCookieContainerDetailPane("necessary")
      };
      var p = h.firstChild;
      p.htmlFor = c.id, p.style.display = "inline-block", p.style.backgroundPositionY = "-1px", h.insertBefore(c, h.firstChild), (c = document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences")).style.zIndex = 1e4, c.style.position = "absolute", (h = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerPreference")).style.paddingTop = "7px", h.style.paddingBottom = "5px", h.style.position = "relative", h.style.zIndex = 1, h.removeAttribute("href"), h.onclick = function (e) {
        "A" == e.target.tagName && CookieConsent.dialog.showCookieContainerDetailPane("preference")
      }, (p = h.firstChild).htmlFor = c.id, p.style.display = "inline-block", p.style.backgroundPositionY = "-1px", h.insertBefore(c, h.firstChild), (c = document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics")).style.zIndex = 1e4, c.style.position = "absolute", (h = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerStatistics")).style.paddingTop = "7px", h.style.paddingBottom = "5px", h.style.position = "relative", h.style.zIndex = 1, h.removeAttribute("href"), h.onclick = function (e) {
        "A" == e.target.tagName && CookieConsent.dialog.showCookieContainerDetailPane("statistics")
      }, (p = h.firstChild).htmlFor = c.id, p.style.display = "inline-block", p.style.backgroundPositionY = "-1px", h.insertBefore(c, h.firstChild), (c = document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing")).style.zIndex = 1e4, c.style.position = "absolute", !this.cookieconsent.hasFramework || "iab" != this.cookieconsent.framework.toLowerCase() && "iabv2" != this.cookieconsent.framework.toLowerCase() || (c.onclick = function () {
        this.checked ? CookieConsent.dialog.IABSelectAll() : CookieConsent.dialog.IABDeselectAll(!0)
      }), (h = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerAdvertising")).style.paddingTop = "7px", h.style.paddingBottom = "5px", h.style.position = "relative", h.style.zIndex = 1, h.removeAttribute("href"), h.onclick = function (e) {
        "A" == e.target.tagName && CookieConsent.dialog.showCookieContainerDetailPane("advertising")
      }, (p = h.firstChild).htmlFor = c.id, p.style.display = "inline-block", p.style.backgroundPositionY = "-1px", h.insertBefore(c, h.firstChild), (h = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerUnclassified")).style.paddingTop = "7px", h.style.paddingBottom = "7px", h.style.borderBottom = "0", document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerTypes").style.backgroundColor = this.customColors.background
    }
  } else this.demomode && (this.DOM.style.zIndex = "100000");
  if (this.demomode || "leveloptin" != this.responseMode && "inlineoptin" != this.responseMode && "custom" != this.template && "optionaloptin" != this.responseMode) !this.demomode || "leveloptin" != this.responseMode && "inlineoptin" != this.responseMode && "custom" != this.template || (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences").checked = this.prechecked.preferences), document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics").checked = this.prechecked.statistics), document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing").checked = this.prechecked.marketing, !this.cookieconsent.hasFramework || "iab" != this.cookieconsent.framework.toLowerCase() && "iabv2" != this.cookieconsent.framework.toLowerCase() || (this.consented || this.declined ? this.consent.marketing ? this.IABSelectAll() : this.IABDeselectAll(!0) : this.prechecked.marketing ? this.IABSelectAll() : this.IABDeselectAll(!0)))); else {
    var u = this.cookieconsent.getCookie(this.cookieconsent.name);
    if (void 0 !== u) if (0 == u.indexOf("{")) {
      var b = u.replace(/%2c/g, ",").replace(/'/g, '"').replace(/([{\[,])\s*([a-zA-Z0-9_]+?):/g, '$1"$2":'),
        m = JSON.parse(b);
      if (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences").checked = m.preferences), document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics").checked = m.statistics), document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing").checked = m.marketing, this.cookieconsent.hasFramework && ("iab" == this.cookieconsent.framework.toLowerCase() ? "function" == typeof __cmp && window.__cmp("applyConsentData") : "iabv2" == this.cookieconsent.framework.toLowerCase() && "undefined" != typeof CookieConsentIABCMP && CookieConsentIABCMP.updateBannerFromConsent())), "optionaloptin" == this.responseMode) if (document.getElementById("CybotCookiebotDialogBodyContentCheckboxPersonalInformation")) if (document.getElementById("CybotCookiebotDialogBodyContentCheckboxPersonalInformation").checked = !m.preferences && !m.statistics && !m.marketing, this.cookieconsent.hasFramework && ("iab" == this.cookieconsent.framework.toLowerCase() || "iabv2" == this.cookieconsent.framework.toLowerCase())) document.getElementById("CybotCookiebotDialogBodyContentCheckboxPersonalInformation").onclick = function () {
        this.checked ? CookieConsent.dialog.IABDeselectAll(!0) : CookieConsent.dialog.IABSelectAll()
      }
    } else "0" == u ? (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences").checked = !1), document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics").checked = !1), document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing").checked = !1, !this.cookieconsent.hasFramework || "iab" != this.cookieconsent.framework.toLowerCase() && "iabv2" != this.cookieconsent.framework.toLowerCase() || this.IABDeselectAll(!0))) : "-2" == u && (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences").checked = this.prechecked.preferences), document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics").checked = this.prechecked.statistics), document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing").checked = this.prechecked.marketing, !this.cookieconsent.hasFramework || "iab" != this.cookieconsent.framework.toLowerCase() && "iabv2" != this.cookieconsent.framework.toLowerCase() || (this.consented || this.declined ? this.consent.marketing ? this.IABSelectAll() : this.IABDeselectAll(!0) : this.prechecked.marketing ? this.IABSelectAll() : this.IABDeselectAll(!0)))); else document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences").checked = this.prechecked.preferences), document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics").checked = this.prechecked.statistics), document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing").checked = this.prechecked.marketing, !this.cookieconsent.hasFramework || "iab" != this.cookieconsent.framework.toLowerCase() && "iabv2" != this.cookieconsent.framework.toLowerCase() || (this.consented || this.declined ? this.consent.marketing ? this.IABSelectAll() : this.IABDeselectAll(!0) : this.prechecked.marketing ? this.IABSelectAll() : this.IABDeselectAll(!0)))
  }
  !function () {
    var e = document.getElementById("CybotCookiebotDialogBodyButtonAccept"),
      ...
      t = document.getElementById("CybotCookiebotDialogBodyLevelButtonAccept"),
      i = document.getElementById("CybotCookiebotDialogBodyLevelButtonLevelOptinAllowAll"),
      n = document.getElementById("CybotCookiebotDialogBodyLevelButtonLevelOptinAllowallSelection"),
      s = document.getElementById("CybotCookiebotDialogBodyLevelButtonLevelOptinDeclineAll");
    if ("leveloptin" == y.responseMode) {
      t && (t.onclick = function (e) {
        y.submitConsent(!1)
      }, t.focus()), n && (n.onclick = function (e) {
        y.submitConsent(!1)
      }, n.focus());
      var l = document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences"),
        a = document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics"),
        r = document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing");
      i && l && a && r && (i.onclick = function (e) {
        l.checked = !0, a.checked = !0, r.checked = !0, !CookieConsentDialog.cookieconsent.hasFramework || "iab" != CookieConsentDialog.cookieconsent.framework.toLowerCase() && "iabv2" != CookieConsentDialog.cookieconsent.framework.toLowerCase() || CookieConsent.dialog.IABSelectAll(!0), y.submitConsent(!1)
      }, i.focus()), s && (s.onclick = function (e) {
        return y.submitDecline(e), !1
      }, s.focus());
      var d = document.getElementById("CybotCookiebotDialogBodyLevelButtonNecessary");
      d && (d.parentNode.onclick = function (e) {
        alert(y.mandatoryText + " " + y.htmlDecode(y.cookieIntroTypeNecessary))
      }), (c = document.getElementById("CybotCookiebotDialogBodyLevelDetailsWrapper")) && (c.onclick = function (e) {
        return CookieConsent.dialog.toggleDetails(), !1
      })
    } else if ("optionaloptin" == y.responseMode) {
      (c = document.getElementById("CybotCookiebotDialogBodyButtonDetails")) && (c.onclick = function (e) {
        return CookieConsent.dialog.toggleDetails(), !1
      }), e && (e.onclick = function (e) {
        var o = !0, t = document.getElementById("CybotCookiebotDialogBodyContentCheckboxPersonalInformation");
        return t && t.checked && (o = !1), o ? y.submitConsent(!1) : y.submitDecline(e), !1
      }, e.focus())
    } else {
      var c;
      (c = document.getElementById("CybotCookiebotDialogBodyButtonDetails")) && (c.onclick = function (e) {
        ...
        return y.submitConsent(!1), !1
      }, e.focus()), o && (o.onclick = function (e) {
        return y.submitDecline(e), !1
      })
    }
  }(), this.DOM.style.display = "block", "function" == typeof CookiebotCallback_OnDialogDisplay ? CookiebotCallback_OnDialogDisplay() : "function" == typeof CookieConsentCallback_OnDialogDisplay && CookieConsentCallback_OnDialogDisplay();
  var B = document.createEvent("Event");
  switch (B.initEvent("CookiebotOnDialogDisplay", !0, !0), window.dispatchEvent(B), (B = document.createEvent("Event")).initEvent("CookieConsentOnDialogDisplay", !0, !0), window.dispatchEvent(B), this.template) {
    case"top":
      this.showAtTop();
      break;
    case"bottom":
    ...
    case"overlay":
      ...
      var k = this.DOM.offsetHeight, f = Math.round((this.viewport.winHeight() - k) / 4);
      f < 0 && (f = 0), this.DOM.style.marginTop = f + "px";
      var D = this.DOM.offsetWidth, I = Math.round((this.viewport.winWidth() - D) / 2 - 10);
      if (I < 0 && (I = 0), this.DOM.style.marginLeft = I + "px", "overlay" == this.template) {
        var v = document.createElement("div");
        v.id = "CybotCookiebotDialogBodyUnderlay", v.style.display = "none", v.style.width = "100%", v.style.height = "100%", (e = document.getElementsByTagName("body")[0]).appendChild(v)
      }
      this.fadeIn();
      break;
    case"custom":
  ...
  setTimeout(function () {
    y.setButtonsSize(), y.setZoomLevel()
  }, 50)
}, CookieControl.Dialog.prototype.globalEval = function (e) {
  if (null != e && "" != e) if (window.execScript) window.execScript(e); else {
  ...
  null != e && "custom" != this.template && o && (e.style.transform = "", e.style.webkitTransform = "", e.style.msTransform = "", e.style.MozTransform = "", e.style.OTransform = "", e.style.transformOrigin = "", e.style.webkitTransformOrigin = "", e.style.msTransformOrigin = "", e.style.MozTransformOrigin = "", e.style.OTransformOrigin = "")
}, CookieControl.Dialog.prototype.setZoomLevel = function () {
  var e = 1, o = 1, t = 1, i = this.DOM,
  ...
  if ("custom" != this.template) {
    var e = document.getElementById("CybotCookiebotDialogBodyButtonAccept"),
      o = document.getElementById("CybotCookiebotDialogBodyButtonDecline"), t = 0;
    switch (this.responseMode) {
      ...
      case"optinout":
        if (e && o) {
          var i = e.offsetWidth - 10, n = o.offsetWidth - 10;
          t = Math.max(i, n), 0 < (t = Math.max(80, t)) && (e.style.width = t + "px", o.style.width = t + "px")
        }
        break;
      case"leveloptin":
        var s = document.getElementById("CybotCookiebotDialogBodyLevelButtonAccept"),
          ...
          a = document.getElementById("CybotCookiebotDialogBodyLevelButtonsRow"), r = 0;
        if (a) {
          document.getElementById("CybotCookiebotDialogBodyLevelButtonsTable").style.width = "auto";
          var d = s.offsetWidth, c = l.offsetWidth, y = a.offsetWidth, h = 8, C = h + 4, g = !1;
          if ("overlay" != this.template && "popup" != this.template || (g = !0, h = 24, C = 28), c < y + d + C) try {
            document.getElementById("CybotCookiebotDialogBodyLevelButtonsTable").style.width = c - h + "px"
          } catch (e) {
          } else {
            try {
              document.getElementById("CybotCookiebotDialogBodyLevelButtonsTable").style.width = "auto"
            ...
            if ("rtl" == this.textDirection ? document.getElementById("CybotCookiebotDialogBodyLevelButtons").style.float = "right" : document.getElementById("CybotCookiebotDialogBodyLevelButtons").style.float = "left", document.getElementById("CybotCookiebotDialogBodyLevelButtons").style.pointerEvents = "auto", !g) {
              var p = document.getElementById("CybotCookiebotDialogBodyContentText");
              if (p) {
                var u = p.offsetWidth, b = document.getElementById("CybotCookiebotDialogBodyLevelButtons");
                b && (y + d + 4 <= u ? (r = document.getElementById("CybotCookiebotDialogBodyContent").offsetWidth - u - 2, (!this.showLogo || this.viewport.winWidth() <= this.autoHideLogoWidth) && (r += 2), "rtl" == this.textDirection ? (b.style.marginLeft = "0px", b.style.marginRight = r + "px") : (b.style.marginLeft = r + "px", b.style.marginRight = "0px")) : "rtl" == this.textDirection ? (b.style.marginLeft = "0px", b.style.marginRight = "8px") : (b.style.marginLeft = "8px", b.style.marginRight = "0px"))
              }
            }
          }
        }
        var m = document.getElementById("CybotCookiebotDialogBodyLevelButtonLevelOptinAllowAll"),
          B = document.getElementById("CybotCookiebotDialogBodyLevelButtonLevelOptinAllowallSelection"),
          k = document.getElementById("CybotCookiebotDialogBodyLevelButtonLevelOptinDeclineAll"), f = m && B,
          D = "allowallorselection" == this.buttonMode && f, I = m && B && k,
          v = "allowselectdecline" == this.buttonMode && I;
        if (D) {
          var A = m.offsetWidth - 10, T = B.offsetWidth - 10;
          t = Math.max(A, T), 0 < (t = Math.max(80, t)) && (m.style.width = t + "px", B.style.width = t + "px");
          var L = g ? c - h : c - r;
          try {
            document.getElementById("CybotCookiebotDialogBodyLevelButtonsTable").style.width = L + "px"
          } catch (e) {
          }
        } else if (v) {
          A = m.offsetWidth - 10, T = B.offsetWidth - 10;
          var E = k.offsetWidth - 10;
          0 < (t = Math.max(80, A, T, E)) && (m.style.width = t + "px", B.style.width = t + "px", k.style.width = t + "px");
          L = g ? c - h : c - r;
          try {
            document.getElementById("CybotCookiebotDialogBodyLevelButtonsTable").style.width = L + "px"
          } catch (e) {
          }
          document.getElementById("CybotCookiebotDialogBodyLevelWrapper").offsetWidth < 3 * (22 + t) ? (m.style.display = "block", B.style.display = "block", k.style.display = "block") : (m.style.display = "", B.style.display = "", k.style.display = "")
        }
    }
  }
}, CookieControl.Dialog.prototype.hide = function () {
  this.visible = !1, document.getElementById(this.DOMid) && ("custom" == this.template ? ("function" != window.eval.call(window, "typeof(" + this.customTemplateDef.FunctionHideName + ")") && this.globalEval(this.customTemplateDef.Script), this.globalEval(this.customTemplateDef.FunctionHideName + "()")) : (this.fadeOut(), "pushdown" == this.template && document.body && (document.body.style.paddingTop = this.bodyPaddingTopInit + "px"))), this.cookieconsent && this.cookieconsent.hasFramework && "iabv2" === this.cookieconsent.framework.toLowerCase() && "object" == typeof CookieConsentIABCMP && CookieConsentIABCMP.updateConsentFromBanner()
  ...
  switch (this.template) {
    ...
    case"slideup":
      ...
      (t = this.viewport.winHeight() - o) < 0 && (t = 0), this.DOM.style.top = Math.round(t) + "px";
      break;
    case"popup":
    case"overlay":
      ...
      var t, i = this.DOM.offsetHeight;
      (t = Math.round((this.viewport.winHeight() - i) / 4)) < 0 && (t = 0), this.DOM.style.marginTop = t + "px", this.DOM.style.marginLeft = "0px";
      var n = this.DOM.offsetWidth, s = Math.round((this.viewport.winWidth() - n) / 2 - 10);
  ...
  var e = parseInt(this.DOM.offsetHeight), o = this;
  ...
  this.DOM.style.opacity = 1, this.DOM.style.filter = "alpha(opacity=100)";
  var e = parseInt(this.DOM.scrollHeight), o = this;
  ...
  var e = this, o = document.getElementById("CybotCookiebotDialogBodyUnderlay");
  if (o) {
    100 == this.faderPos && (null != document.body.style.overflow && null != document.body.style.overflow && "" != document.body.style.overflow && (this.bodyOverflow = document.body.style.overflow), document.body.style.overflow = "hidden"), o.style.height = this.viewport.docHeight() + "px", o.style.width = this.viewport.docWidth() + "px", o.style.display = "block", o.style.opacity = (80 - this.faderPos) / 100, o.style.filter = "alpha(opacity=" + (80 - this.faderPos) + ")"
  }
  ...
  o && (o.style.height = this.viewport.docHeight() + "px", o.style.display = "block", o.style.opacity = (this.faderPos - 20) / 100, o.style.filter = "alpha(opacity=" + (this.faderPos - 30) + ")"), this.DOM.style.opacity = this.faderPos / 100, this.DOM.style.filter = "alpha(opacity=" + this.faderPos + ")", this.faderPos -= 5, this.faderPos < 0 && (this.faderPos = 0), 0 < this.faderPos ? setTimeout(function () {
    e.fadeOut()
  }, 1) : (this.DOM.style.display = "none", o && (o.style.display = "none", null != this.bodyOverflow ? document.body.style.overflow = this.bodyOverflow : document.body.style.overflow = "auto"), this.faderPos = 100)
  ...
  var i = window.location.href;
  if (o && 0 === o.indexOf(location.protocol + "//" + location.host) && (i = o), this.demomode || (this.cookieconsent.consented = !0, this.cookieconsent.declined = !1, this.cookieconsent.hasResponse = !0, this.impliedConsentOnScroll && this.detachOnscrollEvent(), this.cookieconsent.consent.preferences = !0, this.cookieconsent.consent.statistics = !0, this.cookieconsent.consent.marketing = !0, "leveloptin" != this.responseMode && "inlineoptin" != this.responseMode && "custom" != this.template || ("object" == typeof CookieConsent.dialog.prechecked && "custom" != this.template && (this.cookieconsent.consent.preferences = this.prechecked.preferences, this.cookieconsent.consent.statistics = this.prechecked.statistics, this.cookieconsent.consent.marketing = this.prechecked.marketing), document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences") ? document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences").checked ? this.cookieconsent.consent.preferences = !0 : this.cookieconsent.consent.preferences = !1 : document.getElementById("CookieConsentDialogBodyLevelButtonPreferences") && (document.getElementById("CookieConsentDialogBodyLevelButtonPreferences").checked ? this.cookieconsent.consent.preferences = !0 : this.cookieconsent.consent.preferences = !1), document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics") ? document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics").checked ? this.cookieconsent.consent.statistics = !0 : this.cookieconsent.consent.statistics = !1 : document.getElementById("CookieConsentDialogBodyLevelButtonStatistics") && (document.getElementById("CookieConsentDialogBodyLevelButtonStatistics").checked ? this.cookieconsent.consent.statistics = !0 : this.cookieconsent.consent.statistics = !1), document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing") ? document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing").checked ? this.cookieconsent.consent.marketing = !0 : this.cookieconsent.consent.marketing = !1 : document.getElementById("CookieConsentDialogBodyLevelButtonMarketing") && (document.getElementById("CookieConsentDialogBodyLevelButtonMarketing").checked ? this.cookieconsent.consent.marketing = !0 : this.cookieconsent.consent.marketing = !1), this.cookieconsent.responseMode = this.responseMode)), this.hide(), "undefined" != typeof CookieDeclaration && "function" == typeof CookieDeclaration.SetUserStatusLabel && CookieDeclaration.SetUserStatusLabel(), !this.demomode) {
    var n = "false";
    ...
    void 0 !== t && (l = t);
    var a = "";
    0 < this.cookieconsent.pathlist.length && (a = "&path=" + encodeURIComponent(this.cookieconsent.pathlist.join(","))), this.cookieconsent.hasFramework && this.cookieconsent.frameworkLoaded && "iab" == this.cookieconsent.framework.toLowerCase() ? window.__cmp("getConsentData", null, function (e) {
    ...
    }) : this.cookieconsent.hasFramework && this.cookieconsent.frameworkLoaded && "iabv2" == this.cookieconsent.framework.toLowerCase() ? window.__tcfapi("getTCData", 2, function (e) {
      CookieConsent.IABConsentString = e.tcString, a += "&iab2=" + CookieConsent.IABConsentString, CookieConsent.getScript(CookieConsent.host + "logconsent.ashx?action=accept&nocache=" + (new Date).getTime() + "&referer=" + encodeURIComponent(i) + "&dnt=" + n + "&method=" + s + "&clp=" + CookieConsent.consent.preferences + "&cls=" + CookieConsent.consent.statistics + "&clm=" + CookieConsent.consent.marketing + "&cbid=" + CookieConsent.serial + a + "&cbt=" + CookieConsent.responseMode + "&hasdata=true", l)
  ...
  if (this.hide(), !this.demomode) {
    ...
    var o = "";
    0 < this.cookieconsent.pathlist.length && (o = "&path=" + encodeURIComponent(this.cookieconsent.pathlist.join(","))), this.cookieconsent.hasFramework && this.cookieconsent.frameworkLoaded && "iab" == this.cookieconsent.framework.toLowerCase() ? window.__cmp("getConsentData", null, function (e) {
      o += "&iab=" + e.consentData, CookieConsent.getScript(CookieConsent.host + "logconsent.ashx?action=decline&nocache=" + (new Date).getTime() + "&referer=" + encodeURIComponent(window.location.href) + "&cbid=" + CookieConsent.serial + o + "&cbt=" + CookieConsent.responseMode + "&hasdata=true")
    }) : this.cookieconsent.hasFramework && this.cookieconsent.frameworkLoaded && "iabv2" == this.cookieconsent.framework.toLowerCase() ? (this.IABDeselectAll(!0), "object" == typeof CookieConsentIABCMP && CookieConsentIABCMP.updateConsentFromBanner(), window.__tcfapi("getTCData", 2, function (e) {
      CookieConsent.IABConsentString = e.tcString, o += "&iab2=" + CookieConsent.IABConsentString, CookieConsent.getScript(CookieConsent.host + "logconsent.ashx?action=decline&nocache=" + (new Date).getTime() + "&referer=" + encodeURIComponent(window.location.href) + "&cbid=" + CookieConsent.serial + o + "&cbt=" + CookieConsent.responseMode + "&hasdata=true")
    })) : this.cookieconsent.getScript(this.cookieconsent.host + "logconsent.ashx?action=decline&nocache=" + (new Date).getTime() + "&referer=" + encodeURIComponent(window.location.href) + "&cbid=" + this.cookieconsent.serial + o + "&cbt=" + CookieConsent.responseMode + "&hasdata=true"), this.cookieconsent.resetCookies()
  }
  ...
  var o, t = document.getElementById("CybotCookiebotDialogDetail");
  o = "leveloptin" == this.responseMode ? document.getElementById("CybotCookiebotDialogBodyLevelDetailsButton") : document.getElementById("CybotCookiebotDialogBodyButtonDetails");
  var i = new CookieControl.CSS(o);
  if (t) {
    var n;
    switch (this.template) {
      case"top":
    ...
    if ("inlineoptin" == this.responseMode) {
      if ("block" == t.style.display) {
        ...
        if (0 < parseInt(a.clientHeight)) {
          ...
          var r = 170 - parseInt(a.clientHeight);
          a.style.paddingTop = r + "px"
        }
      }
    } else if ("block" == t.style.display) {
      (a = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerNecessary")).style.borderTop = "0px";
      var d = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2Intro");
      d && (d.style.borderTop = "0px")
    }
  }
  this.resize()
}, CookieControl.Dialog.prototype.showDetailPane = function (e) {
  for (var o = ["CybotCookiebotDialogDetailBodyContentTextAbout", "CybotCookiebotDialogDetailBodyContentTextIAB", "CybotCookiebotDialogDetailBodyContentTextIABv2", "CybotCookiebotDialogDetailBodyContentTextOverview"], t = 0; t < o.length; t++) {
    var i = document.getElementById(o[t]);
    i && (i.style.display = "none")
  }
  var n = ["CybotCookiebotDialogDetailBodyContentTabsAbout", "CybotCookiebotDialogDetailBodyContentTabsIAB", "CybotCookiebotDialogDetailBodyContentTabsIABv2", "CybotCookiebotDialogDetailBodyContentTabsOverview"];
  ...
  switch (e.toLowerCase()) {
    case"overview":
      ...
      break;
    case"iab":
      l = document.getElementById("CybotCookiebotDialogDetailBodyContentTabsIAB"), a = document.getElementById("CybotCookiebotDialogDetailBodyContentTextIAB");
      break;
    case"iabv2":
      l = document.getElementById("CybotCookiebotDialogDetailBodyContentTabsIABv2"), a = document.getElementById("CybotCookiebotDialogDetailBodyContentTextIABv2");
      break;
    default:
      l = document.getElementById("CybotCookiebotDialogDetailBodyContentTabsAbout"), a = document.getElementById("CybotCookiebotDialogDetailBodyContentTextAbout")
  }
  ...
  var i, n,
    s = ["CybotCookiebotDialogDetailBodyContentCookieContainerNecessary", "CybotCookiebotDialogDetailBodyContentCookieContainerPreference", "CybotCookiebotDialogDetailBodyContentCookieContainerStatistics", "CybotCookiebotDialogDetailBodyContentCookieContainerAdvertising", "CybotCookiebotDialogDetailBodyContentCookieContainerUnclassified"];
  for (t = 0; t < s.length; t++) {
    document.getElementById(s[t]).className = "CybotCookiebotDialogDetailBodyContentCookieContainerTypes"
  }
  switch (e.toLowerCase()) {
    case"preference":
      i = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerPreference"), n = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieTabsPreference");
      break;
    case"statistics":
      i = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerStatistics"), n = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieTabsStatistics");
      break;
    case"advertising":
      i = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerAdvertising"), n = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieTabsAdvertising");
      break;
    case"unclassified":
      i = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerUnclassified"), n = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieTabsUnclassified");
      break;
    default:
      i = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerNecessary"), n = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieTabsNecessary")
  }
  ...
  var i, n,
    s = ["CybotCookiebotDialogDetailBodyContentIABv2Purposes", "CybotCookiebotDialogDetailBodyContentIABv2Features", "CybotCookiebotDialogDetailBodyContentIABv2Partners"];
  for (t = 0; t < s.length; t++) {
    document.getElementById(s[t]).className = "CybotCookiebotDialogDetailBodyContentCookieContainerTypes"
  }
  switch (e.toLowerCase()) {
    case"features":
      i = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2Features"), n = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2TabFeatures");
      break;
    case"partners":
      i = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2Partners"), n = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2TabPartners");
      break;
    default:
      i = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2Purposes"), n = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2TabPurposes")
  }
  i && (i.className = "CybotCookiebotDialogDetailBodyContentIABv2TabSelected"), n && (n.scrollIntoView(!0), n.style.display = "block")
}, CookieControl.Dialog.prototype.setStateUnchecked = function () {
  setTimeout(function () {
    document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences").checked = !1), document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics").checked = !1), document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing").checked = !1), !this.cookieconsent.hasFramework || "iab" != this.cookieconsent.framework.toLowerCase() && "iabv2" != this.cookieconsent.framework.toLowerCase() || this.IABDeselectAll(!0)
  }, 100)
}, CookieControl.Dialog.prototype.getIABPurposeById = function (e) {
  for (var o = 0; o < this.IABSettings.purposes.length; o++) if (this.IABSettings.purposes[o].id == e) return this.IABSettings.purposes[o].name;
  return ""
}, CookieControl.Dialog.prototype.getIABFeatureById = function (e) {
  for (var o = 0; o < this.IABSettings.features.length; o++) if (this.IABSettings.features[o].id == e) return this.IABSettings.features[o].name;
  return ""
}, CookieControl.Dialog.prototype.getIAB2PurposeById = function (e) {
  for (k in this.IABGVL.purposes) if (this.IABGVL.purposes[k].id == e) return this.IABGVL.purposes[k].name;
  return ""
}, CookieControl.Dialog.prototype.getIAB2FeatureById = function (e) {
  for (k in this.IABGVL.features) if (this.IABGVL.features[k].id == e) return this.IABGVL.features[k].name;
  return ""
}, CookieControl.Dialog.prototype.IABSelectPurposes = function () {
  for (var e = document.getElementsByClassName("CybotCookiebotDialogBodyIABButtonPurposes"), o = 0; o < e.length; o++) e[o].checked = !0;
  ...
  for (var e = document.getElementsByClassName("CybotCookiebotDialogBodyIABButtonFeatures"), o = 0; o < e.length; o++) e[o].checked = !0
}, CookieControl.Dialog.prototype.IABDeselectFeatures = function () {
  for (var e = document.getElementsByClassName("CybotCookiebotDialogBodyIABButtonFeatures"), o = 0; o < e.length; o++) e[o].checked = !1
}, CookieControl.Dialog.prototype.IABSelectVendors = function () {
  for (var e = document.getElementsByClassName("CybotCookiebotDialogBodyIABButtonVendors"), o = 0; o < e.length; o++) e[o].checked = !0;
  ...
  document.getElementById("CybotCookiebotDialogDetail") && "block" != document.getElementById("CybotCookiebotDialogDetail").style.display && this.toggleDetails(), this.showDetailPane("iabv2"), this.showCookieContainerIABv2DetailPane("partners")
}, CookieControl.Dialog.prototype.IABDeselectAll = function (e) {
  this.IABDeselectPurposes(e), this.IABDeselectFeatures(), this.IABDeselectVendors(e)
}, CookieControl.Dialog.prototype.IABToggleContainer = function (e) {
  var o = document.getElementById(e);
  if (o && (new CookieControl.CSS(o).toggleClass("CybotCookiebotDialogBodyLevelButtonIABContainer", "CybotCookiebotDialogBodyLevelButtonIABContainerCollapsed"), o.firstChild)) {
    var t = new CookieControl.CSS(o.firstChild);
    t.toggleClass("CybotCookiebotDialogBodyLevelButtonIABContainerToggleShow", "CybotCookiebotDialogBodyLevelButtonIABContainerToggleHide"), t.hasClass("CybotCookiebotDialogBodyLevelButtonIABContainerToggleShow") ? o.firstChild.title = this.IABResourceStrings.expand : o.firstChild.title = this.IABResourceStrings.collapse
  }
}, CookieControl.Viewport = function () {
  this.docHeight = function () {
    var e = window, o = document, t = o.documentElement, i = o.getElementsByTagName("body")[0];
    ...
    var e = window, o = document, t = o.documentElement, i = o.getElementsByTagName("body")[0];
    return e.innerWidth || t.clientWidth || i.clientWidth
  }, this.findPos = function (e) {
    var o = curtop = 0;
    if (e.offsetParent) for (; o += e.offsetLeft, curtop += e.offsetTop, e = e.offsetParent;) ;
    return [o, curtop]
  }, this.getPageScroll = function () {
    var e, o;
    return self.pageYOffset ? (o = self.pageYOffset, e = self.pageXOffset) : document.documentElement && document.documentElement.scrollTop ? (o = document.documentElement.scrollTop, e = document.documentElement.scrollLeft) : document.body && (o = document.body.scrollTop, e = document.body.scrollLeft), [e, o]
  }, this.findPosRelativeToViewport = function (e) {
    var o = this.findPos(e), t = this.getPageScroll();
  ...
  if (0 < e.length) for (var o = 0; o < e.length; o++) e[o].parentNode.removeChild(e[o]);
  ...
  if (this.hasClass(e)) {
    ...
    this.HTMLElement.className = this.HTMLElement.className.replace(o, " ")
  }
}, CookieControl.CSS.prototype.replaceClass = function (e, o) {
  this.hasClass(e) && (this.removeClass(e), this.addClass(o))
...
CookieConsentDialog.logo = 'data:image/png;base64,';
...
CookieConsentDialog.customColors.acceptbutton = '#e40303';
...
CookieConsentDialog.lastUpdatedDate = 1584353075870;
CookieConsentDialog.cookieTableNecessary = [["CookieConsent", "ktplay.com", "Stores the user\'s cookie consent state for the current domain", "1 year", "HTTP", "1", "", "cookiebot.com"], ["PHPSESSID", "ktplay.com", "Preserves user session state across page requests.", "Session", "HTTP", "1", "^PHPSESSID.*$", "www.ktplay.com"]];
CookieConsentDialog.cookieTablePreference = [];
CookieConsentDialog.cookieTableStatistics = [["collect", "google-analytics.com", "Used to send data to Google Analytics about the visitor\'s device and behavior. Tracks the visitor across devices and marketing channels.", "Session", "Pixel", "5", "^[r\/]*collect$", "www.google-analytics.com"], ["_ga", "ktplay.com", "Registers a unique ID that is used to generate statistical data on how the visitor uses the website.", "2 years", "HTTP", "1", "", "www.google-analytics.com"], ["_gat", "ktplay.com", "Used by Google Analytics to throttle request rate", "1 day", "HTTP", "1", "^_gat(_.+)*$", "www.google-analytics.com"], ["_gid", "ktplay.com", "Registers a unique ID that is used to generate statistical data on how the visitor uses the website.", "1 day", "HTTP", "1", "", "www.google-analytics.com"], ["Hm_ck_#", "ktplay.com", "Pending", "Session", "HTTP", "1", "^Hm_ck_\d{13}$", "hm.baidu.com"], ["Hm_unsent_3ce7b0a26140e834b2e03cd3ac219bea", "ktplay.com", "Pending", "Session", "HTML", "2", "", "hm.baidu.com"]];
CookieConsentDialog.cookieTableAdvertising = [["IDE", "doubleclick.net", "Used by Google DoubleClick to register and report the website user\'s actions after viewing or clicking one of the advertiser\'s ads with the purpose of measuring the efficacy of an ad and to present targeted ads to the user.", "1 year", "HTTP", "1", "", "doubleclick.net"], ["test_cookie", "doubleclick.net", "Used to check if the user\'s browser supports cookies.", "1 day", "HTTP", "1", "", "doubleclick.net"], ["hm.gif", "hm.baidu.com", "Used to send data to Baidu about the visitor\'s device and behavior. Tracks the visitor across devices and marketing channels.", "Session", "Pixel", "5", "", "hm.baidu.com"], ["HMACCOUNT", "hm.baidu.com", "Used to send data to Baidu about the visitor\'s device and behavior. Tracks the visitor across devices and marketing channels.", "6516 days", "HTTP", "1", "", "hm.baidu.com"], ["pagead/1p-conversion/#", "google.com", "Pending", "Session", "Pixel", "5", "", "www.google.ie"], ["pagead/conversion/#", "googleadservices.com", "Pending", "Session", "Pixel", "5", "^pagead\/conversion\/\d+$", "googleadservices.com"], ["Hm_lpvt_#", "ktplay.com", "Pending", "Session", "HTML", "1", "^Hm_lpvt_[0-f]{32}$", "hm.baidu.com"], ["Hm_lvt_#", "ktplay.com", "Pending", "1 year", "HTML", "1", "^Hm_lvt_[0-f]{32}$", "hm.baidu.com"]];
...
CookieConsentDialog.privacyPolicies = [['cookiebot.com', 'Cookiebot', 'https://www.cookiebot.com/goto/privacy-policy/'], ['doubleclick.net', 'Google', 'https://policies.google.com/privacy'], ['googleadservices.com', 'Google', 'https://policies.google.com/privacy'], ['hm.baidu.com', 'Baidu', 'http://ir.baidu.com/phoenix.zhtml?c=188488&p=privacy'], ['www.google.ie', 'Google', 'https://policies.google.com/privacy'], ['www.google-analytics.com', 'Google', 'https://policies.google.com/privacy']];
CookieConsentDialog.privacyPolicyText = '{0}\'s privacy policy';
CookieConsentDialog.userCountry = 'CN';
